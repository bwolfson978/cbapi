...
def build_cli_parser():
    parser = optparse.OptionParser(usage="%prog [options]", description="Enumerate datasharing configurations for a certain sensor group")
...
def main(argv):
    ...
    if does_exist:
        datasharing_configs = cb.group_datasharing_enum(opts.group_id)

        for config in datasharing_configs:
            print ""
